...
key = 'DO0QlmpG9W8WGlzMkOe5EI4W'  # 这里填写你的百度开放平台的key
...
def translateWgs_to_bd09(position):
...
if __name__ == '__main__':
    ...
    for eachline in flist:
        ...
        cwj.infocomSimulate.tools.writeToFile('../data/intersection_translated', intersection_no + ',' + str(translated[0]) + ',' + str(translated[1]))
